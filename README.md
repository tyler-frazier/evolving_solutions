...
This course is an introductory exploration into the dimensions of global human development and their intersection with data science. Each student will be introduced to state of the art development research on high resolution global: population, natural resource and built environment description.  Students will also explore current work on surveys for demographic analysis, as well as the use of census and call detail records to describe human movement.  In tandem with these seminars on current, highly relevant development topics, students will also be introduced to developing an annotated bibliography, writing a literature review, forming a central research question, and seeking to identify a research gap.  The course concludes with a group presentation and individual research proposal that highlights and summarizes the most significant findings from the semester.
